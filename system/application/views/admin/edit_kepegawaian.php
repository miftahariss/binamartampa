...
{
?>
<option value="guru">Guru</option><option value="pegawai" selected="selected">Pegawai</option><option value="admin">Administrator</option>
<?php
}
else if($status=='guru'){
?>
<option value="guru" selected="selected">Guru</option><option value="pegawai">Pegawai</option><option value="admin">Administrator</option>
<?php
}
else{
?>
<option value="guru">Guru</option><option value="pegawai">Pegawai</option><option value="admin" selected="selected">Administrator</option>
<?php
}
?>
</select>
...
<tr><td width="200">Password Login</td><td width="10" align="center">:</td><td><input type="text" class="input" name="password" size="70" /> *Kosongkan saja jika tidak diganti</td></tr>
