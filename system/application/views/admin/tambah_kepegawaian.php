...
<table width="100%">
<form method="post" action="<?php echo base_url(); ?>index.php/adminweb/simpankepegawaian">
...
<select name="status" class="input"><option value="guru">Guru</option><option value="pegawai">Pegawai</option><option value="admin">Administrator</option></select>
</td></tr>
<tr><td width="200">Username Login</td><td width="10" align="center">:</td><td><input type="text" class="input" name="username" size="70" /></td></tr>
<tr><td width="200">Password Login</td><td width="10" align="center">:</td><td><input type="text" class="input" name="password" size="70" /></td></tr>
