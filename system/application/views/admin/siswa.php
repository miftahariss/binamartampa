...
<table width="100%">
<?php
echo "<tr align='center'><td><strong>Nomor</strong></td><td><strong>Nama Kelas</strong></td><td><strong>Tahun Ajaran</strong></td><td colspan='3' width='10'><strong>Aksi Data</strong></td></tr>";
$no=1;
foreach($kelas->result_array() as $s)
{
	echo "<tr><td>".$no."</td><td>".$s['nama_kelas']."</td><td>".$s['tahun_ajaran']."</td><td>
