...
foreach($statis->result_array() as $s)
{
	...
	<a href='".base_url()."index.php/adminweb/editdatastatis/".$s['id_data']."'><div class='submitButton2'>Edit Data</div></a></td><td><a href='".base_url()."index.php/adminweb/hapusdatastatis/".$s['id_data']."' onClick=\"return confirm('Anda yakin ingin menghapus data ini?')\" ><div class='submitButton2'>Hapus Data</div></a></td></tr>";
}
?>
</table>
</div>