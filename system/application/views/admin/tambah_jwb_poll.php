<div id="isi">
<br>
<h1>Module Polling</h1><br /><!-- Batas Content -->
...
<br /><br /><br />
<form method="post" action="<?php echo base_url(); ?>index.php/adminweb/simpanjwbpoll">
...
<?php
echo"<td>
	<a href='".base_url()."index.php/adminweb/editjwbpoll/".$artikel['id_jawaban_poll']."'><div class='submitButton2'>Edit Data</div></a></td><td><a href='".base_url()."index.php/adminweb/hapusjwbpoll/".$artikel['id_jawaban_poll']."' onClick=\"return confirm('Anda yakin ingin menghapus data ini?')\" ><div class='submitButton2'>Hapus Data</div></a></td>";
?>
</tr>
<?php 
	$no++;
