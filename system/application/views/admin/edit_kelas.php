...
$nama=$e["nama_kelas"];
$tahun=$e["tahun_ajaran"];
$id=$e["id_kelas"];
}
?>
<div id="isi">
<h1>Modul Kelas</h1><br />
...
<tr><td width="200">Tahun Ajaran</td><td width="10" align="center">:</td><td><input type="text" class="input" name="tahun" size="50" value="<?php echo $tahun; ?>"  /></td></tr>
