...
<tr><td></td><td></td><td><img src="<?php echo base_url(); ?>system/application/views/main-web/berita/<?php echo $gambar; ?>" /><br /><br /><input type="file" name="userfile" size="40"/> * Apabila gambar tidak diubah, dikosongkan saja.</td>	</tr>
<tr><td></td><td></td><td><input type="submit"  value="Simpan Data" class="input"/></td>	</tr>
   ...
   <p>&nbsp;</p>     
	...
	<tr>
	<td>Upload file</td><td><input type="file" name="imagefile" size="50"  class="input"/><input type="hidden" name="tujuan" value="editberita/<?php echo $id; ?>" /></td>	
	</tr>
	</table>
