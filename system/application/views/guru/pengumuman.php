...
<div id="isi">
<br>
<a href="<?php echo base_url(); ?>index.php/guru/tambahpengumuman"><div class="pagingpage"><b> + Tambah Pengumuman </b></div><br /><br /></a>
...
<a href='".base_url()."index.php/guru/editpengumuman/".$t->id_pengumuman."' title='Edit Pengumuman'><img src='".base_url()."system/application/views/guru/images/edit-icon.gif' border='0'></a></td>
<td><a href='".base_url()."index.php/guru/hapuspengumuman/".$t->id_pengumuman."' onClick=\"return confirm('Anda yakin ingin menghapus tutorial ini?')\" title='Hapus Pengumuman'><img src='".base_url()."system/application/views/guru/images/hapus-icon.gif' border='0'></a></td>
</td></tr>";
$nomor++;	
}
}
