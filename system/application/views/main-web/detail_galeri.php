...
?>
<div id="judul-berita"><?php echo $judul; ?></div>
<div id="galeri">
<?php
...
<?php
echo"><div id='album-besar'><div id='sub-album'><img src='".base_url()."system/application/views/main-web/galeri/thumb/".$b['foto_kecil']."' border='0'></div></div></a>";
}
?>
</div>
<ul>
<li class="li-class">Tekan tombol panah kiri atau kanan pada keyboard, untuk melihat foto selanjutnya atau sebelumnya.</li>
</ul>
<?php
